        ...
        public static void Main(string[] args)
        {
            ...
            app.Map("/searchform1", async (HttpContext context) =>
            {
                ...
                if (context.Request.Method == "GET")
                {
                    ...
                    html += "<select id='Address' name='Address'>";
                    html += "<option value=''>All</option>";  // Значение по умолчанию для 'All'
                ...
                else if (context.Request.Method == "POST")
                {
                    ...
                    var html = "<h1>Enterprise Search Results</h1>";
                    ...
                    if (enterprise != null)
                    {
                        ...
                        else
                        {
                            ...
                            html += "<tr><th>Violation</th></tr>";
                            foreach (var violation in violations)
                            {
                                html += $"<tr><td>{violation}</td></tr>";
                            }
                            html += "</table>";
                        }
                    }
